 ...
 */
package org.openmrs.module.crossborder.web.controller;
 ...
 */
@Controller("${rootrootArtifactid}.CrossbordermoduleforOpenMRSController")
@RequestMapping(value = "module/${rootArtifactid}/${rootArtifactid}.form")
public class CrossbordermoduleforOpenMRSController {
