...
/**
 * This is a unit test, which verifies logic in CrossbordermoduleforOpenMRSService. It doesn't
 * extend BaseModuleContextSensitiveTest, thus it is run without the in-memory DB and Spring
 * context.
 */
public class CrossbordermoduleforOpenMRSServiceTest {
	
	@InjectMocks
	CrossbordermoduleforOpenMRSServiceImpl basicModuleService;
